...
Se utiliza un Árbol de Desición, el cual fue implementado utilizando el framework de scikit learn. Se incluye un jupyter notevook el cual funge como reporte y codigo implementado. CAMBIOS SUGERIDOS POR RETROALIMENTACIÓN: Se incluye el código en el reporte y se agregan graficas para analizar sesgo, varianza y ajuste del modelo.
